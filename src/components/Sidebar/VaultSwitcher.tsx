      ...
      {isMounted && (
        ...
        >
              ...
              <div key={vault.path} className="group px-1">
                {renaming === vault.path ? (
                  <InlineInput
                    ...
                    className="w-full rounded bg-zinc-900 px-1.5 py-1 text-sm text-white outline outline-1 outline-blue-500"
                  />
                ) : (
                  <div className="flex items-center rounded transition-colors hover:bg-zinc-700/50">
                    <button
                    ...
                    <button
                      ...
                      className={cn(action, "hover:text-white")}
                    >
                    ...
                    <button
                      ...
                      className={cn(action, "mr-0.5 hover:text-red-400")}
                    >
                      <X className="h-3 w-3" />
                    </button>
                  </div>
          ...
          <button
            ...
            className="flex w-full cursor-pointer items-center gap-2 border-t border-zinc-700 px-2.5 py-1.5 text-left text-sm text-zinc-400 transition-colors hover:bg-zinc-700/60 hover:text-white"
          >
