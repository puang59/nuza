...
const ALLOWED_TAGS = new Set([
  "a", "abbr", "audio", "b", "big", "blockquote", "br", "caption", "cite", "code", "col",
  "colgroup", "dd", "del", "details", "dfn", "div", "dl", "dt", "em", "figcaption", "figure",
  "h1", "h2", "h3", "h4", "h5", "h6", "hr", "i", "img", "ins", "kbd", "li", "mark", "ol", "p",
  "picture", "pre", "q", "s", "samp", "section", "small", "source", "span", "strong", "sub",
  "summary", "sup", "table", "tbody", "td", "tfoot", "th", "thead", "time", "tr", "u", "ul",
  "video", "wbr",
]);

const ALLOWED_ATTRIBUTES = new Set([
  "align", "alt", "class", "cite", "colspan", "controls", "datetime", "dir", "height", "href",
  "lang", "loop", "muted", "open", "poster", "reversed", "rowspan", "span", "src", "start",
  "style", "title", "type", "width",
]);
...
export function rendersAnything(fragment: DocumentFragment) {
  return fragment.childNodes.length > 0 && (fragment.textContent?.trim() !== "" || !!fragment.querySelector("*"));
}
